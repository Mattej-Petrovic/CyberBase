...
AF_TOPOLOGIES['sql-injection'] = {
  ...
  edges: [
    ...
    { id:'e7', from:'app', to:'db',  label:'parameterized query' },
...
AF_TOPOLOGIES['man-in-the-middle'] = {
  nodes: {
    base: [
      ...
      { id:'rtr',  type:'router',   label:'Router / AP',    sublabel:'802.11',        x:350, y:390 },
  ...
  edges: [
    ...
    { id:'e8', from:'atk', to:'atk',  label:'decrypted session' },
...
AF_TOPOLOGIES['lateral-movement'] = {
  ...
  edges: [
    ...
    { id:'e7', from:'atk', to:'h1', label:'credential dump' },
...
AF_TOPOLOGIES['supply-chain-attack'] = {
  ...
  phases: [
    ...
    { attacker:{ activeNodes:['oa','ob','oc','atk'],      activeEdges:['e4','e5','e6','e7'], tools:['backdoor call-home'] },
      ...
      victim:  { activeNodes:['oa','ob','oc'],           activeEdges:['e7'],               compromisedNodes:['oa','ob','oc'], unaware:false } },
  ],
};
